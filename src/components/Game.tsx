...
function Game() {
        ...
        if (gameOver) return;
            ...
            if (currentTile === 5 && !gameOver){
                ...
                for (let i = 0; i < 5; i++){
                    ...
                    if (color === 'gr' || (color === 'y' && current !== 'gr') || (color === 'g' && current !== 'gr' && current !== 'y')){
    ...
    return (
        <>
        <div className={`game-container ${gameOver? "blurred" : ""}`}>
            ...
            <div className="game-board">
                {board.map((row, rowIndex) => (
                    <div className={`game-row ${rowIndex === winningRow ? "winning-row" : ""}`} key={rowIndex}>
